...
type AcademicUsecase interface {
	...
	GetSessionByID(ctx context.Context, id int64) (*entity.AcademicSession, error)
	...
	GetSubjectByID(ctx context.Context, id int64) (*entity.Subject, error)
...
func (uc *academicUsecase) CreateSession(ctx context.Context, session *entity.AcademicSession) error {
...
func (uc *academicUsecase) UpdateSession(ctx context.Context, session *entity.AcademicSession) error {
	if err := uc.validate.Struct(session); err != nil {
		return err
	}
...
func (uc *academicUsecase) DeleteSession(ctx context.Context, id int64) error {
	return uc.repo.DeleteSession(ctx, id)
}

func (uc *academicUsecase) GetSessionByID(ctx context.Context, id int64) (*entity.AcademicSession, error) {
	return uc.repo.FindSessionByID(ctx, id)
}
...
func (uc *academicUsecase) CreateClass(ctx context.Context, class *entity.Class) error {
...
func (uc *academicUsecase) UpdateClass(ctx context.Context, class *entity.Class) error {
	if err := uc.validate.Struct(class); err != nil {
		return err
	}
...
func (uc *academicUsecase) DeleteClass(ctx context.Context, id int64) error {
	return uc.repo.DeleteClass(ctx, id)
}

func (uc *academicUsecase) GetClassByID(ctx context.Context, id int64) (*entity.Class, error) {
	return uc.repo.FindClassByID(ctx, id)
}
...
func (uc *academicUsecase) CreateSection(ctx context.Context, section *entity.Section) error {
...
func (uc *academicUsecase) UpdateSection(ctx context.Context, section *entity.Section) error {
	if err := uc.validate.Struct(section); err != nil {
		return err
	}
...
func (uc *academicUsecase) DeleteSection(ctx context.Context, id int64) error {
	return uc.repo.DeleteSection(ctx, id)
}

func (uc *academicUsecase) GetSectionByID(ctx context.Context, id int64) (*entity.Section, error) {
	return uc.repo.FindSectionByID(ctx, id)
}
...
func (uc *academicUsecase) UpdateSubject(ctx context.Context, subject *entity.Subject) error {
	if err := uc.validate.Struct(subject); err != nil {
		return err
	}
...
func (uc *academicUsecase) DeleteSubject(ctx context.Context, id int64) error {
	return uc.repo.DeleteSubject(ctx, id)
}

func (uc *academicUsecase) GetSubjectByID(ctx context.Context, id int64) (*entity.Subject, error) {
	return uc.repo.FindSubjectByID(ctx, id)
}
